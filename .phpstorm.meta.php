...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Rania\Herd\adoptme_fix\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Rania\\Herd\\adoptme_fix\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'home','kontak','tentang','hewan',
'hewan.show','keranjang','daftarkanhewan.form','daftarkanhewan.store','dashboard',
'profile.show','profile.edit','profile.update','profile.destroy','panduan',
'adopsi.form','adopsi.submit','adopsi.konfirmasi','register',
'login','password.request','password.email','password.reset',
'password.store','password.confirm','password.update','logout',
'adopsi.store','daftarkanhewan.form','daftarkanhewan.store','storage.local',);
        registerArgumentsSet('views', 
'adopsi.form','adopsi.konfirmasi','auth.confirm-password','auth.forgot-password','auth.login',
...
'components.secondary-button','components.text-input','dashboard','home','keranjang',
'layouts.app','layouts.guest','layouts.navigation','panduan','profil',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','user.daftarkanhewan',
'user.hewan','user.home_content','user.kontak','user.profil','user.tentang',
